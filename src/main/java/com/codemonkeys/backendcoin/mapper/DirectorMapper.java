...
public interface DirectorMapper {
    @Select("select IFNULL((select director_name from director where director_name=#{director_name}),null)")
    ...
    @Select("select IFNULL((select director_id from director_to_movie where director_id=#{director_id} and movie_id=#{movie_id}),null)")
